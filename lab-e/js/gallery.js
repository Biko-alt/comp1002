// IMPORTANT: Before you start, be sure to customize all href="" values within the server include html files so your site navigation works
...
const blockLinks = blockGallery.querySelectorAll ? blockGallery.querySelectorAll('header > nav > ul > li > a'): [];
...
blockLinks.forEach((link) => {
    ...
    link.onclick = function(event) {
        ...
        // STEP 4b: Grab the IMG element just below the UL containing the links to each of the block images with the appropriate ID (look at the HTML in 'red/gallery.html') and assign it to a variable of the same name - use document.getElementById below
